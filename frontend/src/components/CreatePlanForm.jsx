  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="form-group">
        <label className="form-label" htmlFor="topic">What do you need to learn?</label>
        <input
          id="topic"
          name="topic"
      ...
      <div className="form-group">
        <label className="form-label" htmlFor="courseUrl">Course URL (optional)</label>
        <input
          id="courseUrl"
          name="courseUrl"
          className="form-input"
      ...
      <div className="form-group">
        ...
        />
        <small style={{color: '#718096'}}>Be realistic - quality over quantity!</small>
      </div>
...
{useCustomTime && (
  <div className="form-group">
    <label className="form-label" htmlFor="startTime">What time do you start studying?</label>
    <input
      id="startTime"
      name="startTime"
      className="form-input"
